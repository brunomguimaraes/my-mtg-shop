...
import { CartProductsList_shoppingCart$ref } from "./CartProductsList_shoppingCart.graphql";
declare const _NavBar_user$ref: unique symbol;
export type NavBar_user$ref = typeof _NavBar_user$ref;
